...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1511819734);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1511819685);
...
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1511740800);
user_pref("browser.newtabpage.activity-stream.migrationRemainingDays", 3);
user_pref("browser.newtabpage.activity-stream.prerender", false);
user_pref("browser.newtabpage.blocked", "{\"26UbzFJ7qT9/4DhodHKA1Q==\":1,\"4gPpjkxgZzXPVtuEoAL9Ig==\":1,\"INRfnhzxUVkzjp9y2ALvsQ==\":1,\"Qm5mllFgWNfyfJYyBFM6+A==\":1,\"gLv0ja2RYVgxKdp0I5qwvA==\":1,\"eV8/WsSLxHadrTL1gAxhug==\":1}");
user_pref("browser.newtabpage.enhanced", false);
user_pref("browser.newtabpage.storageVersion", 1);
user_pref("browser.onboarding.notification.finished", true);
user_pref("browser.onboarding.notification.last-time-of-changing-tour-sec", 1511819705);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1511819690021");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1511823290021");
user_pref("browser.search.countryCode", "DE");
user_pref("browser.search.region", "DE");
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20171115002005");
user_pref("browser.shell.mostRecentDateSetAsDefault", "1511819861");
...
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1511819688348");
user_pref("e10s.rollout.cohort", "test");
user_pref("e10s.rollout.cohortSample", "0.469422");
...
user_pref("extensions.lastAppBuildId", "20171115002005");
...
user_pref("extensions.shield-recipe-client.user_id", "78887e5a-b4f6-4ba3-aa09-c1bc2bf8f56a");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"29581c23-72dc-4848-94f2-38e91f6bf124\"}");
...
user_pref("toolkit.startup.last_success", 1511819859);
user_pref("toolkit.telemetry.cachedClientID", "ef4a2b97-7ab7-49f5-983a-b774f8783720");
